...
自然な美しさをご提案いたします。"></h2>
        <p class="gosic mb25">私たちは丁寧なカウンセリングを心がけており、<br>
          患者様のご要望やお悩みに寄り添い、<br class="pc">その方に合った治療法をご提案いたします。<br class="pc">またナチュラルで違和感のない仕上がりを重視します。</p>
    ...
    <div class="lp-inner">
      <div class="box box-size">
        ...
        <div class="desc-box flex">
          <div class="desc gosic"> お顔の下垂が原因で法令線ができる場合など、<br class="pc">法令線だけ埋めても全体的に見ると<br class="pc"><span class="cp">不自然な仕上がり</span>になってしまう事もあります。<br class="pc">しわに沿って注入する事も出来ますが、下垂の程度、<br class="pc">ボリュームロスの程度など<span class="cp">トータルで判断</span>し、<br class="pc"><span class="cp">ナチュラルな美しさを追及</span>できる注入量を<br class="pc">ご提案する事が大事だと考えています。 </div>
...
当院は、下記のクレジットカードのご利用が可能です。</p><div class="card-img"><img src="<?php echo get_template_directory_uri(); ?>/img/common/card.png?0918" alt="カード"></div>
          </div>
