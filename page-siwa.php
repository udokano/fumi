...
皮膚の乾燥や肌老化による小じわ、ちりめんジワ)があり、しわの種類によって治療方法が異なります。診察によってより適切なしわ治療をご提案させていただきます。</p>
    ...
    <div class="ancor-box">
        ...
        <a href="#area1">ボトックス注射</a><a href="#area2">ヒアルロン酸</a><a href="#area3">美容内科・美容点滴</a>
...
<section class="features layout1">
  <div class="inner-box2">
    <h2 class="cp gosic tc ls1">美容内科・美容点滴の特徴</h2>
    <div class="box">
      <div class="thumb"><img src="<?php echo get_template_directory_uri(); ?>/img/operation/siwa/point06.jpg" alt="ポイントエリアサムネイル"></div>
      <div class="desc box-size bg-grade">
        <div class="points f-ryu cw">Point.1</div>
        <h3 class="gd ls1">老化予防</h3>
        <p class="gosic">進行する肌老化を抑制し、若々しいお肌を保つことができます</p>
      </div>
    </div>
    <div class="box cf">
      <div class="thumb"><img src="<?php echo get_template_directory_uri(); ?>/img/operation/siwa/point07.jpg" alt="ポイントエリアサムネイル"></div>
      <div class="desc box-size bg-grade">
        <div class="points f-ryu cw">Point.2</div>
        <h3 class="gd ls1">美肌効果</h3>
        <p class="gosic">たるみやシワ、シミといった肌トラブルを解消して、滑らかなお肌を保つことができます。</p>
      </div>
      </div>
      
      <div class="box">
      <div class="thumb"><img src="<?php echo get_template_directory_uri(); ?>/img/operation/siwa/point08.jpg" alt="ポイントエリアサムネイル"></div>
      <div class="desc box-size bg-grade">
        <div class="points f-ryu cw">Point.3</div>
        <h3 class="gd ls1">メスを入れない</h3>
        <p class="gosic">進行する肌老化を抑制し、若々しいお肌を保つことができます</p>
      </div>
    </div>
    <div class="box cf">
      <div class="thumb"><img src="<?php echo get_template_directory_uri(); ?>/img/operation/siwa/point09.jpg" alt="ポイントエリアサムネイル"></div>
      <div class="desc box-size bg-grade">
        <div class="points f-ryu cw">Point.4</div>
        <h3 class="gd ls1">ダウンタイムが<br>
ほとんどない</h3>
        <p class="gosic">施術後の腫れや副作用がほとんどない為、すぐに元の日常生活に戻ることが可能です。</p>
      </div>
      </div>
