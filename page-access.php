...
<section class="access-info bg-cp">
  <div class="inner">
    ...
    <section class="access-info">
      ...
      <div class="info gosic">
          ...
          <ul class="flex gosic">
              <li><div class="thumb">
                      <img src="<?php echo get_template_directory_uri(); ?>/img/access/access1_1.jpg" alt="アクセス方法">
              ...
              <li><div class="thumb">
                      <img src="<?php echo get_template_directory_uri(); ?>/img/access/access1_2.jpg" alt="アクセス方法">
                  
                  </div>
              
                  <h4 class="cp tc">順路❷</h4>
                  
                  <p>阪急三番街の地蔵横丁の出口から外に出たら、阪急三番街を背にして、左方向に直進します。</p>
              
              
              </li>
              
              <li><div class="thumb">
                      <img src="<?php echo get_template_directory_uri(); ?>/img/access/access1_3.jpg" alt="アクセス方法">
                  
                  </div>
              
                  <h4 class="cp tc">順路❸</h4>
                  
                  <p>しばらく進んで、スクランブル交差点（国道176号線）が見えたら斜め右方向に交差点を渡って、その後右方向に進みます。</p>
              
              
              </li>
        
              <li><div class="thumb">
                      <img src="<?php echo get_template_directory_uri(); ?>/img/access/access1_4.jpg" alt="アクセス方法">
              ...
              <li><div class="thumb">
                      <img src="<?php echo get_template_directory_uri(); ?>/img/access/access1_5.jpg" alt="アクセス方法">
              ...
              <li><div class="thumb">
                      <img src="<?php echo get_template_directory_uri(); ?>/img/access/access1_6.jpg" alt="アクセス方法">
                  
                  </div>
              
                  <h4 class="cp tc">順路❻</h4>
                  
                  <p>左方向に進み、料理教室の看板（赤い看板）が見える交差点を右方向に進みます。</p>
              
              
              </li>
              
              <li><div class="thumb">
                      <img src="<?php echo get_template_directory_uri(); ?>/img/access/access1_7.jpg" alt="アクセス方法">
         ...
         <div class="info gosic"><h3 class="tc">JR大阪駅・御堂筋線梅田からのアクセス方法</h3> 
          ...
          <ul class="flex gosic">
              <li><div class="thumb">
                  ...
                  <p>3番出口(ヨドバシカメラ直結)から地上にあがり、国道176号線に沿って矢印の方向に進みます。
</p>
  ...
  <p>左方向に進み、料理教室の看板（赤い看板）が見える交差点を右方向に進みます。が見えたら、左方向に進みます。</p>
              ...
              <li><div class="thumb">
                  ...
                  <h4 class="cp tc">順路❼</h4><p>右に進むとすぐに、専門学校とセブンイレブンに挟まれた、芝田ビルの3Fがふみビューティークリニック梅田になります。     
...
fumi beauty clinicと駐車場との提携は行っておりません。</p>
                ...
                <ul class="parking flex gosic">
                
                    <li>
                        <h4 class="gd ls1 tc">タイムズグランフロント大阪東第2</h4>
                        
                        <div class="thumb"><img src="<?php echo get_template_directory_uri(); ?>/img/access/parking01.jpg" alt="パーキング"></div>
                           <p class="tc"><a href="https://www.google.com/maps/@34.7075886,135.4960266,3a,90y,237.96h,73.83t/data=!3m6!1e1!3m4!1sXwKZyECb02lB4uoY6jb3DA!2e0!7i16384!8i8192" target="_blank" class="cp">GoogleMAPを開く</a></p>
                    
                    </li>
                    
                    
                    <li>
                        <h4 class="gd ls1 tc">タイムズ大阪梅田駐車場</h4>
