  ...
  <div class="fv" id="fv-slide">
    <div class="swiper-container fv-slide" >
      <div class="swiper-wrapper fv-slider-content">
        <div class="fv__slide-wrap swiper-slide slide01">
          <div class="inner-box">
            <div class="fv-top-wrap">
              <div class="top">
                ...
                <!--logos-->
                <h1><img src="<?php echo get_template_directory_uri(); ?>/img/top/fv2_cach.png" alt="洗練された美容技術であなたの美しさを引き出します。" class="pc"> <img src="<?php echo get_template_directory_uri(); ?>/img/top/fv_cach_sp.png" alt="洗練された美容技術であなたの美しさを引き出します" class="sp"></h1>
              </div>
              <!--top END--> 
            </div>
            <!--FV-top-wrap END--> 
        ...
        <div class="fv__slide-wrap swiper-slide slide02">
          <div class="inner-box">
            <div class="fv-top-wrap">
              <div class="top">
                <div class="logos"> <img src="<?php echo get_template_directory_uri(); ?>/img/top/fv_logo.png" alt="FMUI BEAUTY CLINIC">
                  <div class="band cp tc ls2">お好きなキャッチコピーを入力してください</div>
                  <!--band END--> 
                </div>
                <!--logos-->
                <h1 class="tc cp">お好きなテキストを入力してください</h1>
              </div>
              <!--top END--> 
            </div>
            <!--FV-top-wrap END--> 
        ...
        <div class="fv__slide-wrap swiper-slide slide03">
          <div class="inner-box">
            <div class="fv-top-wrap">
              <div class="top">
                <div class="logos"> <img src="<?php echo get_template_directory_uri(); ?>/img/top/fv_logo.png" alt="FMUI BEAUTY CLINIC">
    ...
    <!-- swiper-container END--> 
        <a href="#contents1" class="bounce scroll-down"><img src="<?php echo get_template_directory_uri(); ?>/img/common/scrool_down.svg" alt="scroll-down"></a> 
  </div>
  <!-- fv END--> 
  ...
  <div class="bottom inner-box flex">
    ...
    <div class="cv-wrap box-size">
      ...
      <div class="bottom__btn flex"> <a href="https://fumibeauty.reserve.ne.jp/" class="cv-btns bg-rs" target="_blank"><span class="bg-icon">来院予約<br>
        ...
        <span class="sm">CONTACT</span></span></a> 
        </div>
    </div>
  </div>
  <!--BOTTOM END--> 
...
<?php else: ?>
<?php endif; ?>
<a href="#" class="page-top bounce"><img src="<?php echo get_template_directory_uri(); ?>/img/common/scrool_up.svg" alt="scrool-up"></a>
</div>
<!--WRAPPER END--> 
