        ...
        <header class="site-header front" id="header">
            <div class="header-inner flex al-cent">
                <div class="logo tc"><a href="<?php echo home_url('/'); ?>"> <img
                            src="<?php echo get_template_directory_uri(); ?>/img/common/logo_re.png?<?php echo filemtime(get_template_directory() . '/img/common/logo_re.png');?>"
                            alt="FUMI BEAUTY CLINIC"></a></div>
