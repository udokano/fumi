...
ご提案を行います。"></h3>
      ...
      <p class="tc ls1 gd mb20 pc">ヒアルロン酸注入治療ではこれらのバランスを見ながらよりその方に合った<br>
        ...
        アプローチできる治療です。</p>
      <p class="tc ls1 gd mb20 sp">ヒアルロン酸注入治療ではこれらのバランスを見ながらよりその方に合った理想のバランス（黄金バランス）に整えていくように注入します。たるみ 、 ボリュームロス、 輪郭、これらがトータルで改善し、老化に対して根本からアプローチできる治療です。</p>
...
自然な美しさをご提案いたします。"></h2>
        ...
        <p class="gosic"> <span class="fs-midle cp mincho">もちろん部分的なご相談も可能です。</span><br>
          ...
          トータルフェイシャルトリートメントをおすすめしておりますが、<br class="pc">
          部分的な注入も行っております。<br>
          是非お気軽にご相談も可能ください。 </p>
      </div>
    </div>
    ...
    <div class="lp-inner">
      <div class="box box-size">
        ...
        <div class="desc-box flex">
          <div class="desc gosic"> お顔の下垂が原因で法令線ができる場合など、<br class="pc">法令線だけ埋めても全体的に見ると<br>
    ...
    <div class="lp-inner">
      ...
      <div class="case-photos flex">
        ...
        <div class="note box-size">
          ...
          <p class="gosic tc pc">個人差がありますが、注入後、内出血が生じることがあります。<br class="pc">内出血によってアザができた場合は1～2週間程度で消滅します。<br class="pc">軽い腫れや軽度の疼痛が出る方もいますが、多くの場合翌日には治ります。</p>
