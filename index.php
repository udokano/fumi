...
<?php bloginfo('name'); ?>
    ...
    <link rel="stylesheet"
        href="<?php echo get_template_directory_uri(); ?>/css/style.css?<?php echo filemtime(get_stylesheet_directory() . '/css/style.css'); ?>">
    <link rel="stylesheet"
        href="<?php echo get_template_directory_uri(); ?>/css/add.css?<?php echo filemtime(get_stylesheet_directory() . '/css/add.css'); ?>">
    <script>
    (function(d) {
        var config = {
                kitId: 'yrq5rir',
...
<body <?php body_class(); ?> id="top">
    <div class="wrapper">
        <header class="site-header front" id="header">
            <div class="header-inner flex al-cent">
                <div class="logo tc"><a href="<?php echo home_url('/'); ?>"> <img
                            src="<?php echo get_template_directory_uri(); ?>/img/common/logo_re.png?02085"
                            alt="FMUI BEAUTY CLINIC"></a></div>
                ...
                <div class="top-cv-btn">
                    <a class="bg-rs cv-btns" href="https://fumibeauty.reserve.ne.jp/" target="_blank">
                        <i class="cv-btns__icon  cv-btns__icon--online"><img
                                src="<?php echo get_template_directory_uri(); ?>/img/common/icon_online.png"
                                alt="オンライン予約"></i>
                        <span class="cv-btns__text">オンライン<br class="sp">予約</span>
                    </a>
                    <a class="bg-ct cv-btns" href="<?php echo home_url('/'); ?>contact">
                        <i class="cv-btns__icon cv-btns__icon--mail"><img
                                src="<?php echo get_template_directory_uri(); ?>/img/common/icon_mail03.png"
                                alt="お問合わせ"></i>
                        <span class="cv-btns__text">お問合わせ</span>
                    </a>
                    <a class="bg-line cv-btns" href="https://line.me/R/ti/p/%40304ngjfp" target="_blank">
                        <i class="cv-btns__icon cv-btns__icon--line"><img
                                src="<?php echo get_template_directory_uri(); ?>/img/common/icon_line03.png"
                                alt="LINEで簡単予約"></i>
        ...
        <main>
            <div class="fv fv-re" id="fv-slide">
                <div class="fv__catch-text">
                    <div class="fv__catch-inner">
                        <div class="fv__catch-img">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/top/fv_text.png"
                                alt="みなさまお一人お一人が美しく年齢を重ね、輝き続けられるよう最良の治療でお手伝いいたします" class="pc">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/top/fv_text_sp.png"
                                alt="みなさまお一人お一人が美しく年齢を重ね、輝き続けられるよう最良の治療でお手伝いいたします" class="sp">
                        </div>
                        <!-- ./catch-img -->
                    </div>
                    <!-- ./inner -->
                ...
                <a href="#bg4" class="bounce scroll-down"><img
                        src="<?php echo get_template_directory_uri(); ?>/img/common/scrool_down.svg"
                        alt="scroll-down"></a>
            </div>
            <!-- fv END-->
            ...
            <div class="top__menu__area top__menu__area--pb">
                <div class="bottom bottom--re inner-box  flex al-cent">
                    <ul class="menu-link menu-link--width flex">
                        <li class="box-size"> <a href="<?php echo home_url('/'); ?>order_made" target="_blank"> <img
                                    src="<?php echo get_template_directory_uri(); ?>/img/top/thumb01_new.jpg"
                                    alt="サムネイル">
                                <p class="tc">オーダーメイド注入<br>
            <span class="gd">INJECTION</span></p>
                            </a> </li>
                        <li class="box-size"> <a href="<?php echo home_url('/'); ?>order_made_thread_lift"
                                target="_blank"> <img
                                    src="<?php echo get_template_directory_uri(); ?>/img/top/thumb02_new.jpg"
                                    alt="サムネイル">
          ...
          <span class="sm">CONTACT</span></span></a> </div>
                    ...
                    <a href="<?php echo home_url( '/' ); ?>medikaru" class="" target="_blank">
                        ...
                        <a href="<?php echo home_url( '/' ); ?>hifu" class="" target="_blank">
                            ...
                            <img src="<?php echo get_template_directory_uri(); ?>/img/common/hifu_bnr.jpg?20200304"
                                alt="ウルトラセルQプラス" class="sp">
                        </a>

                        <a href="<?php echo home_url( '/' ); ?>pfc" class="" target="_blank">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/common/pfc_bnr02.png?20200304"
                                alt="PFC治療" class="pc">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/common/pfc_bnr.png?20200304"
                                alt="PFC治療" class="sp">
                        </a>
                    </div>
                </div>
                ...
                <div class="cv-bottom" id="cv-btm">
                    ...
                    <div class="cv-wrap box-size" id="cv-wrap">
                        ...
                        <div class="bottom__btn flex"> <a href="https://fumibeauty.reserve.ne.jp/"
                                class="cv-btns bg-rs c_gray" target="_blank"><span class="bg-icon">来院予約<br>
                                    <span class="sm">RESERVATION</span></span></a> <a
                                href="<?php echo home_url('/'); ?>contact" class="cv-btns c_gray bg-ct bg__n_ct"><span
                                    class="bg-icon">お問合わせ<br>
                                    <span class="sm">CONTACT</span></span></a> </div>
                    </div>
                    <!-- ./cv-wrap -->
                </div>
            ...
            <section class="box-size mb0 area-bgs">
                <div class="inner cf ttlTxt">
                    <h1
                        class="cach gd c_gray tc title">シワ・たるみの治療は<span class="sp_br">ふみビューティークリニック梅田</span><span class="sm c__l_gold ttlSpan">fumi beauty clinic</span></h1>
            ...
            <section class="doctor box-size mb0 area-bgs" id="bg4">
                <div class="inner cf">
                    <div class="text">
                        ...
                        <h2
                            class="aging tc"><img src="<?php echo get_template_directory_uri(); ?>/img/top/beautiful_aging.png?0513" alt="beautiful_aging"></h2>
                        <p class="cach gd c_gray tc f-ryu">美しく年齢を重ね輝き続けるために</p>
                        <div class="btn-wrap"> <a href="<?php echo home_url('/'); ?>doctor"
                                class="btn fw600 bg__n_rs c_gray gosic">院長紹介</a> <a
                                href="<?php echo home_url('/'); ?>concept"
                                class="btn fw600 bg__n_ct gosic c_gray">当院について</a> </div>
                    </div>
        ...
        先山 史</p>
            ...
            <div class="banner-arwa" id="contents1">
                <div class="swiper-container swiper1 cont">
                    <div class="swiper-wrapper sp-bnr">
                        ...
                        <div class="swiper-slide"><a href="<?php the_sub_field('bnr_sp_link', 28); ?>"
                                target="_blank"><img src="<?php the_sub_field('bnr_sp_img', 28); ?>"
                                    alt="キャンペーンバナー"></a></div>
                        <?php endwhile; ?>
                    </div>
            ...
            <div class="banner-arwa" id="contents1">
                <div class="swiper-container swiper1 cont">
                    <div class="swiper-wrapper pc-bnr">
                        ...
                        <div class="swiper-slide"><a href="<?php the_sub_field('bnr_pc_link', 28); ?>"
                                target="_blank"><img src="<?php the_sub_field('bnr_pc_img', 28); ?>"
                                    alt="キャンペーンバナー"></a></div>
                        <?php endwhile; ?>
                    </div>
                    <div class="swiper-button-prev"></div>
                ...
                <div class="inner-box">
                    <div class="top flex">
                        <div class="text text__left tc cp c_gray box-size">
                            <div class="tit__box">
                                <h3>注入治療</h3><span class="sm c__l_green">Cosmetic injections</span></div>
                            <p
                                class="gosic tc">ヒアルロン酸やボトックスを「どこに」「どのくらい」<br class="pc">注入するかで、大きく効果が違ってきますが、<br class="pc">当院ではお顔全体のバランスをみて<br class="pc">自然な若返りができるようご提案しております。</p>
                            <a href="<?php echo home_url('/'); ?>pr1" class="btn fw600 bg__n_rs c_gray"
                                target="_blank">当院のヒアルロン酸注入</a>
                        </div>

                        <div class="text text__right tc cp c_gray box-size">
                            <div class="tit__box">
                                <h3>製剤一覧</h3><span class="sm c__l_green">Available products</span></div>
                            ...
                            <a href="<?php echo home_url('/'); ?>list" class="btn fw600 bg__n_rs c_gray">詳しく見る</a>
                        </div>
                    </div>
          ...
          <a href="<?php echo home_url('/'); ?>list" class="btn fw600 bg__n_rs c_gray">詳しく見る</a> </div>
            ...
            <section class="menu area-bgs mb0" id="bg3">
                ...
                <ul class="munu-link flex">
                    <li class="box-size hg-row"> <a href="<?php echo home_url('/'); ?>tarumi">
                            ...
                            <div class="thumb"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/top/thumb05.jpg" alt="サムネイル">
                            </div>
                            <ul>
                    ...
                    <li class="box-size hg-row"> <a href="<?php echo home_url('/'); ?>siwa">
                            <h3 class="tc">しわ治療 </h3>
                            <div class="thumb"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/top/thumb06.jpg" alt="サムネイル">
                            </div>
                            <ul>
                                <li>・ヒアルロン酸</li>
                                <li>・ボトックス注射</li>
                    ...
                    <li class="box-size hg-row"> <a href="<?php echo home_url('/'); ?>medikaru">
                            ...
                            <ul class="col">
                                ...
                                <li data-url="<?php echo home_url('/'); ?>medikaru#area6" class="js-link">・ウルトラセルQプラス<br
                                        class="sp">(リニア2.0)</li>
                            </ul>
                        </a> </li>
                    <li class="box-size "> <a href="<?php echo home_url('/'); ?>kogao">
                            <h3 class="tc">小顔治療 </h3>
                            <div class="thumb"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/top/thumb07.jpg" alt="サムネイル">
                            </div>
                            <ul class="col">
                                ...
                                <li data-url="<?php echo home_url('/'); ?>kogao#area1" class="js-link">
                                    ・脂肪溶解注射/BNLSneo、デオリポ(カベルライン)、<br class="pc">チンセラプラス</li>
                    ...
                    <li class="box-size"> <a href="<?php echo home_url('/'); ?>nose-lift">
                            ...
                            <div class="thumb"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/top/thumb08.jpg" alt="サムネイル">
                            </div>
                            <ul>
                                <li>・Gメッシュ</li>
                                <li>・Gコグノーズ</li>
                    ...
                    <li class="box-size"> <a href="<?php echo home_url('/'); ?>keiseigeka">
                            ...
                            <div class="thumb"><img
                                    src="<?php echo get_template_directory_uri(); ?>/img/top/thumb09.jpg" alt="サムネイル">
                            </div>
                            <ul class="col">
            ...
            <div class="cosmetics__bnr">
                <div class="inner">
                         <div class="bnr"> <a href="https://shop.fumibeauty.jp/" target="_blank"><img
                                src="<?php echo get_template_directory_uri(); ?>/img/top/onlineshop.png?555555555555555555"
                                alt="ドクターズサプリメントオンラインショップのバナー"></a> </div>
                </div>
            </div>
            <!-- ./エンビロンバナー -->
    ...
    <span class="c__l_green md">information</span></h2>
                <div class="inner02 flex">
                    ...
                    <div class="bnr-cam"> <a href="<?php the_sub_field('cam_link', 28);?>" target="_blank"><img
                                src="<?php the_sub_field('cam_img', 28);?>" alt="月別キャンペーンバナー"></a> </div>
                    <?php endwhile; ?>
                </div>
                <!-- inner END -->
            </div>
            ...
            ?>
                ...
                ?>
                                    ...
                                    <dd>
                                        <dl>
                                            <dt class="qa-txt qa-tit pb0"><span class="q">Q</span>
                                                <?php the_title(); ?>
                                            </dt>
  ...
  while ($the_query->have_posts()) : $the_query->the_post();
          ?>
            ...
            <section class="sns">
                ...
                <div class="inner flex">
                    <div class="bnr"> <a href="http://blog.livedoor.jp/dr_sakiyama" target="_blank"> <img
                                src="<?php echo get_template_directory_uri(); ?>/img/common/blog_bnr.jpg?0310"
                                alt="blog_bnr"> </a> </div>
                    <div class="bnr"> <a href="https://line.me/R/ti/p/%40304ngjfp" target="_blank">
                            <?php if (wp_is_mobile()) : ?>
                            <img src="<?php echo get_template_directory_uri(); ?>/img/common/line_bnr_sp.jpg?0310"
                                alt="line_bnr">
                            <?php else: ?>
                            <img src="<?php echo get_template_directory_uri(); ?>/img/common/line_bnr_pc.jpg?0310"
                                alt="line_bnr">
                            <?php endif; ?>
                        </a> </div>
                </div>
                ...
                <div class="inner flex">
                    <div class="bnr"> <a href="https://www.instagram.com/dr_fumi/" target="_blank">
                            <?php if (wp_is_mobile()) : ?>
                            <img src="<?php echo get_template_directory_uri(); ?>/img/common/insta_bnr_sp.jpg?0310"
                                alt="insta_bnr">
                            <?php else: ?>
                            <img src="<?php echo get_template_directory_uri(); ?>/img/common/insta_bnr.jpg?0310"
                                alt="insta_bnr">
                            <?php endif; ?>
                        </a> </div>
                    <div class="bnr"> <a href="https://twitter.com/@_fumibeauty_" target="_blank"> <img
                                src="<?php echo get_template_directory_uri(); ?>/img/common/twitter_bnr.jpg?0310"
                                alt="twitter_bnr"> </a> </div>
                </div>
                <!-- ./inner -->
            </section>
                    ...
                    <ul class="media__list flex">
                     <li class="media__article">
                            <div class="media__thumb">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/top/article_thumb04.jpg"
                                    alt="サムネイル">
                            </div>
                            <h3 class="media__ttl">美スト2021年3月号掲載<br class="">「7名のドクターのベスト<br class="sp">治療！」</h3>
                            <!-- <a href="http://blog.livedoor.jp/dr_sakiyama/archives/1077336482.html" class="media__link" target="_blank">詳しく見る</a> -->
                        </li>
                         <li class="media__article">
                            <div class="media__thumb">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/top/article_thumb03.jpg"
                                    alt="サムネイル">
                            </div>
                            <h3 class="media__ttl media__ttl--line01">美スト2021年1月号掲載</h3>
                            <!-- <a href="http://blog.livedoor.jp/dr_sakiyama/archives/1077336482.html" class="media__link" target="_blank">詳しく見る</a> -->
                        </li>
                        <li class="media__article">
                            <div class="media__thumb">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/top/article_thumb02.jpg"
                                    alt="サムネイル">
                            </div>
                            <h3 class="media__ttl media__ttl--line01">VOCE2020年6月号掲載</h3>
                            <!-- <a href="http://blog.livedoor.jp/dr_sakiyama/archives/1077336482.html" class="media__link" target="_blank">詳しく見る</a> -->
                        </li>
                        <li class="media__article">
                            <div class="media__thumb">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/top/article_thumb01.jpg"
                                    alt="サムネイル">
                            </div>
          ...
          ご利用について</h2>
                        ...
                        <div class="thumb"><img
                                src="<?php echo get_template_directory_uri(); ?>/img/common/card.png?0918"
                                alt="クレジットカード"></div>
                    </div>
                </div>
            </section>
        ...
        <nav class="hambargar bg__n_rs">
            <ul>
                <li class="menu-logo"><img
                        src="<?php echo get_template_directory_uri(); ?>/img/top/fv_logo_re.png?543201" alt="menu-logo">
                </li>
                <li><a href="<?php echo home_url('/'); ?>concept" class="c_gray">当院について</a></li>
                <li class="parent"><a href="#" id="ac-txt" class="c_gray c_gray_line">施術・料金</a>
                    <ul class="child" id="ac">
                        <li class="child__price"><a href="<?php echo home_url('/'); ?>price" class="c_gray">料金一覧</a>
                        </li>
                        <li><a href="<?php echo home_url('/'); ?>tarumi" class="c_gray">たるみ治療</a></li>
                        <li><a href="<?php echo home_url('/'); ?>siwa" class="c_gray">しわ治療</a></li>
                        <li><a href="<?php echo home_url('/'); ?>medikaru" class="c_gray">美肌治療</a></li>
        ...
        <div class="fix-bottom bg__n_rs">
            <ul class="flex gosic al-cent">
                ...
                <li class="box-size c_gray_line02"><a href="https://fumibeauty.reserve.ne.jp/" class="cw c_gray"
        ...
        <?php else: ?>
        <?php endif; ?>
        <a href="#" class="page-top bounce"><img
                src="<?php echo get_template_directory_uri(); ?>/img/common/scrool_up.svg?0615" alt="scrool-up"></a>
    </div>
    <!--WRAPPER END-->
...
<!--     <script>
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDBwr6DPo5X5S4CbkcKpSV5atpzNnKAifI&callback=initMap">
    </script> -->
    <?php wp_footer(); ?>
