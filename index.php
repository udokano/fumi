...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/style.css?0907">
<script>
  (function(d) {
    var config = {
      kitId: 'yrq5rir',
...
<script src="<?php echo get_template_directory_uri(); ?>/js/scripts.js?0907"></script> 
<script>
    function initMap() {
