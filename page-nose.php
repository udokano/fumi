  ...
  <div class="inner-box2">
    <div class="box flex">
      <div class="desc">
        ...
        <p class="gosic">PCL(ポリカプロラクトン)素材の特殊なメッシュ状の吸収糸を特殊な針で挿入し、鼻筋にボリュームを出す施術です。腫れや痛みが少なく、鼻筋に自然なボリュームを与えます。</p>
      </div>
      <div class="thumb"> <img src="<?php echo get_template_directory_uri(); ?>/img/operation/nose/thumb02.jpg" alt="サムネイル"> </div>
    </div>
  </div>
</div>
<div class="wrap">
